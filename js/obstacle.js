...
class Obstacle extends Sprite {
  ...
  draw() {
    const obstacleImage = this.getCurrentAsset().img;
    const mapX = this.x - this.game.skier.x - obstacleImage.width / 2;
    const mapY = this.y - this.game.skier.y - obstacleImage.height / 2;
