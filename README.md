...
New Features Added:
* WASD support
* Score is tracked based on distance traveled from the starting position
* Hiscore is tracked and saved on the session
* User can restart game after crashing into an obstacle
* Skier will gain accelerate 1 unit every 2500 points earned

Bugs Fixed:
* After crashing, pressing LEFT causes an error and canvas stops rendering
* After crashing, pressing RIGHT causes the skier to stand up and face LEFT
